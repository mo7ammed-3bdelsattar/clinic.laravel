                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img src="{{FileHelper::get_file_path($user->image?->path,'user')}}"
                                ...
                                <form action="{{route('profile.updateImage')}}" class="py-1 d-inline" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PATCH')
                                ...
                                <form action="{{route('profile.destroyImage')}}" class="py-1 d-inline" method="POST">
                                    @csrf
                                    @method('DELETE')
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted">{{$user->doctor->address}}</p>
                            <hr>
                            @endif
