...
Route::prefix('admin')->as('admin.')->group(function () {
    Route::middleware(['admin','auth'])->group(function () {
        ...
        Route::patch('profile/update-image/{id}', [ProfileController::class, 'updateImage'])->name('profile.updateImage');
        Route::delete('profile/destroy-image/{id}', [ProfileController::class, 'destroyImage'])->name('profile.destroyImage');
        ...
        Route::get('chats/messages/{id}', [MessageController::class, 'messages'])
            ->name('chats.messages');
        Route::get('users/add-role/{id}', [UserController::class, 'addRole'])->name('users.addRole');
        Route::post('users/assign-role/{id}', [UserController::class, 'assignRole'])->name('users.assignRole');
    });
